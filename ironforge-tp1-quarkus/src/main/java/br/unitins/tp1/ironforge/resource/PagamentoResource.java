...
public class PagamentoResource {
    ...
    public Response gerarPix(@PathParam("idPedido") Long idPedido) {
        ...
        return Response.status(Status.CREATED).entity(pagamentoService.gerarPix(idPedido, username)).build();
    }
    ...
    public Response gerarBoleto(@PathParam("idPedido") Long idPedido) {
        String username = jsonWebToken.getSubject();
        return Response.status(Status.CREATED).entity(pagamentoService.gerarBoleto(idPedido, username)).build();
    }
