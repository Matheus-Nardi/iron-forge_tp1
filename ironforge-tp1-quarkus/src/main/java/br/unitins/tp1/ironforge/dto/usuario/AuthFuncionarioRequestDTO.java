...
public record AuthFuncionarioRequestDTO(
                ...
                @NotNull(message = "O perfil deve ser informado") @Min(value = 1, message = "O perfil informado deve ser no mínimo 1(Funcionario)") @Max(value = 2, message = "O perfil informado deve ser no máximo 2(Clirnte)") Integer perfil) {
