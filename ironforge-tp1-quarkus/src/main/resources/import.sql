...
INSERT INTO usuario (username, senha, dataCadastro) VALUES 
    ('joao.silva', 'OaF4paP+SqLenJW8Rjrk5goXvajn1knmWXfupry55Kbkpll5xliVH9X3U8hMf6l4x/d2WnYf30xNVYTtLu7jmQ==', '2024-01-01'),  -- Senha é abacatecompimenta
    ('wheyHot', '123456', '2024-02-01'),
    ('maxuel', 'qOf0Qw7LIP5PqpJJMwKqcX6BZ+t+elaNZW+fBPY70EsAhd2deno3eb2KnjlTMC06GwBMhShPtQJM8k308HXQog==', '2024-03-01'), -- Senha é flamengo
    ('growthsuplementos', 'senhaSegura', '2024-04-01'),
    ('adm', 'LMhb+caa8FQpEB8Z7vaIdH+yNDMA9f4KrJhXp2p8wsw38+5yu4t7ovC5R5Gko/0XcmacvwntPvzflwvxNiMXSQ==', '2024-05-01');  -- adm123
